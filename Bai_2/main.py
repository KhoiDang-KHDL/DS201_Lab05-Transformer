...
from dataloader import PhoNER_COVID19, Vocab, collate_fn
from sequen_labeling import TransformerModel

class Config:
    DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    
    TRAIN_PATH = "/kaggle/input/phoner/PhoNER/train_word.json" 
    DEV_PATH   = "/kaggle/input/phoner/PhoNER/dev_word.json"     
    TEST_PATH  = "/kaggle/input/phoner/PhoNER/test_word.json"
