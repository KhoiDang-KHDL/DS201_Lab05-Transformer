...
class Config:
    ...
    TRAIN_PATH = "/kaggle/input/uit-viocd/UIT-ViOCD/train.json"
    DEV_PATH   = "/kaggle/input/uit-viocd/UIT-ViOCD/dev.json"
    TEST_PATH  = "/kaggle/input/uit-viocd/UIT-ViOCD/test.json"
